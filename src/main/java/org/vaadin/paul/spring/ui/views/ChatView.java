...
public class ChatView extends VerticalLayout implements RouterLayout{
	...
	public ChatView(Bot alice, ScheduledExecutorService executorService) {
		   ...
		   /* createHeader();
		    ...
		    Button voice= new Button(VaadinIcon.VOLUME.create(),event ->voiceMessage());
		    Button voicestop= new Button(VaadinIcon.STOP.create(),event ->voiceStop());
		  
		    send.addClickShortcut(Key.ENTER);
		    voice.addClickShortcut(Key.AUDIO_VOLUME_UP);
		    voicestop.addClickShortcut(Key.AUDIO_VOLUME_MUTE);
		    HorizontalLayout inputLayout = new HorizontalLayout(message,voice,voicestop, send);
	...
	/*private void createHeader() {
		...
		com.vaadin.flow.component.applayout.AppLayout.addToNavbar(header);
	}
	private void createDrawer() {
		RouterLink listLink =new RouterLink("List", ChatView.class);
