...
public class WelcomeView extends VerticalLayout {
    ...
    public WelcomeView(@Autowired MessageBean bean) {
        ...
        button.setId("SingleBotbutton");
        button1.setId("SingleBotbutton");
       ...
       // setSizeFull();
        ...
        botLayout.add(new Section(
        		
				new H2(new RouterLink("DEMO CHATBOT",
						ChatView.class)),
				new H3(new RouterLink("Sign Up Here For Multiple Bots",
						RegisterView.class)),
				new Paragraph("The final example to demonstrate my LAZY CHATBOT")));
